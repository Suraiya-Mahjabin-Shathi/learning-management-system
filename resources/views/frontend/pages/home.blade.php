    ...
    <div class="container-xxl py-5">
      <div class="container">
          ...
          <div class="row g-4 justify-content-center">
              ...
              <div class="col-lg-4 col-md-6 wow fadeInUp" id="categories" data-wow-delay="0.3s">
                  <div class="card" style="width: 18rem;">
                      ...
                      <div class="card-body">
                        <a  href=" {{ route('user.cat_course',$data->id) }}" class="btn addBtn form-control" aria-describedby="myBtn">View Details</a>
                      </div>
                  </div>
              </div>
              @endforeach
